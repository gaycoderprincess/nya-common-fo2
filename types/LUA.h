...
auto lua_pushnumber = (int(*)(void*, float))0x5B46A0;
...
auto lua_pushboolean = (int(*)(void*, int))0x5B49C0;
auto lua_pushlstring = (int(*)(void*, const wchar_t*, size_t))0x5B4720;
...
auto lua_tolstring = (const wchar_t*(*)(void*, int, void*))0x5B4400;
